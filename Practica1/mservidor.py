...
class memorama:
    ...
    def turno_jugador(self,socket,jugador):
        ...
        socket.send((self.tablero[x1][y1]).encode('utf8'))              #E4 Envia el tablero con la primer casilla destapada
        ...
        socket.send((self.tablero[x2][y2]).encode('utf8'))
    ...
    def tirada_pc(self, jugador, conn):
        while True and self.cont != 0:                                  #mientras existan parejas
            ...
            conn.send((self.tablero[x1][y1]).encode('utf8'))           #E2  Envia el tablero despues de la tirada del pc
            conn.send((self.tablero[x2][y2]).encode('utf8'))
